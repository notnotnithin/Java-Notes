...
**ExecutorService**: ExecutorService got released as part of a Java5. If I have to explain about ExecutorService in a single statement, then ExecutorService is an **Asynchronous Task Execution Engine**.
